...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("BilousEventHubNamespace")
                .setEventHubName("bilouseventhub")
                .setSasKeyName("Endpoint=sb://bilouseventhubnamespace.servicebus.windows.net/;SharedAccessKeyName=BilousPolicy;SharedAccessKey=vnpXyLyWcNHEzNjaCjE6xzs+FEoiA2DDoZQgWVUXmX0=;EntityPath=bilouseventhub")
                .setSasKey("vnpXyLyWcNHEzNjaCjE6xzs+FEoiA2DDoZQgWVUXmX0=");
