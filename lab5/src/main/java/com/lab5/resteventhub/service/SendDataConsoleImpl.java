...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "BilousDnsName.redis.cache.windows.net";
    private final static String CACHE_KEY = "dJ9OqQDZzsIRoZb8z5vYNo7AWjqjjGOuLt5jYCjs80s=";
